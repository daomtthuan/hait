...
class Admin extends MY_Controller
{
	...
	{
		$data['role'] = 'admin';
		$data['page_title'] = 'Danh sách biểu mẫu nhiễm khuẩn bệnh viện';
		$data['main'] = 'tool/analysis/list_bieumau';

		$this->load->view('general/layout', $data);
	}

	public function baocao_sobo_kq_giamsat()
	{
		$data['role'] = 'admin';
		$data['page_title'] = 'Báo cáo sơ bộ kết quả giám sát nhiễm khuẩn bệnh viện';
		$data['main'] = 'tool/analysis/bacao_sobo_kq_giamsat';

		$this->load->view('general/layout', $data);
	}

	public function list_bn_dieutra_nkbv()
	{
		$data['role'] = 'admin';
		$data['page_title'] = 'Danh sách bệnh nhân điều tra nhiễm khuẩn bệnh viện (Giám sát ngang)';
		$data['main'] = 'tool/analysis/list_bn_dieutra_nkbv';
