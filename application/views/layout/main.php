...
<div id="wrapper">
	<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
		<li>
			<a class="sidebar-brand d-flex align-items-center justify-content-center bg-white" href="<?php echo base_url('/user')?>">
				<div class="sidebar-brand-icon">
					<img src="<?php echo base_url('public/img/logo.png')?>" width="33" height="33" alt="">
				</div>
				<div class="sidebar-brand-text text-primary mx-3" style="font-size: 0.56rem">
					<div class=" text-dark">Hệ Thống Quản Lý</div>
					<div>Giám Sát Nhiễm Khuẩn</div>
					<div>Bệnh Viện</div>
				</div>
			</a>
		</li>
		...
		<li class="nav-item">
			...
			<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
				<div class="bg-white py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href=""><i class="fas fa-file-medical mr-2"></i>Tạo mới</a>
					<a class="collapse-item" href="<?php echo base_url('/user/view/') ?>"><i class="fas fa-clipboard-list mr-2"></i>Danh sách</a>
				</div>
			</div>
		</li>
