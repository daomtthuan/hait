...
<form class="mb-3 rounded-lg">
  <div class="card shadow mb-4 border-primary rounded-lg">
    ...
    <div class="card-body bg-white">
      <div class="row">
        <div class="col-md-6 order-md-1 was-validated">
        ...
        <div class="col-md-6 order-md-3 was-validated">
          <div class="form-group">
        ...
        <div class="col-md-6 order-md-5 was-validated">
          <div class="form-group">
        ...
        <div class="col-md-6 order-md-2 was-validated">
          <div class="form-group">
        ...
        <div class="col-md-6 order-md-4 was-validated">
          <div class="form-group">
        ...
        <div class="col-md-6 order-md-6 was-validated">
          <div class="form-group">
        ...
        <div class="col-12 order-last">
          <div class="form-group">
            <label class="text-dark" for="khac_step3">Khác</label>
            <textarea id="khac_step3" name="khac_step3" type="text" class="form-control ellipsis"></textarea>
          </div>
        </div>
      </div>
    </div>
...
<div class="row mt-3">
  <a id="buttonStepBack" class="btn btn-secondary ml-2" href="<?php echo base_url($role.'/new-form/2') ?>">Trở về</a>
  <a id="buttonStepNext" class="btn btn-primary ml-auto mr-2" href="<?php echo base_url($role.'/new-form/4') ?>">Kế tiếp</a>
</div>
