        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <div class="custom-control custom-radio">
                <input type="radio" id="khong_co_ho_hap_man_tinh" name="ho_hap_man_tinh" class="custom-control-input" value="0" required>
                <label class="custom-control-label" for="khong_co_ho_hap_man_tinh">Không</label>
