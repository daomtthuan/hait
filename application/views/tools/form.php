...
<div class="row mb-3">
  <div class="col-2"><button class="stepback btn btn-block btn-secondary">Kế tiếp</button></div>
  <div class="col-8">
    a
  </div>
  <div class="col-2"><button class="stepnext btn btn-block btn-primary">Kế tiếp</button></div>
</div>
<form action="" class="mb-3">
  <div id="step1">
    <h5 class="text-primary">1. Thông tin chung</h5>
    <div class="row">
      <div class="col-sm-6">
